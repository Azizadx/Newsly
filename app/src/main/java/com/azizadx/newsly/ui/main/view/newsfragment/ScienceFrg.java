...
public class ScienceFrg extends Fragment {
    String country = "us";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.activity_scinence,null);
        recyclerViewofscience = v.findViewById(R.id.rcviewofscinence);
