...
public class EntertainmentFrg extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.activity_entertainment,null);
        recyclerViewofentertainment = v.findViewById(R.id.rcviewofentertainment);
